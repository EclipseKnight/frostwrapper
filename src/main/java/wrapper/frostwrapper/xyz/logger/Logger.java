package wrapper.frostwrapper.xyz.logger;
...
public class Logger {
	 ...
	 */
	public static String PATH = Launcher.UWD  + File.separator + "frostwrapper" + File.separator + "logs";
	...
	private static void addShutdownHook() {
		Runtime.getRuntime().addShutdownHook(new Thread( () -> {
			...
			log(Level.INFO, "Logger shutdown hook finished!");
		}));
	}
}
